...
DATA_DIR = os.path.normpath(os.path.join(COMPONENT_DIR, "..", "data"))

# 恐惧
with open(os.path.join(DATA_DIR, "phobias.json"), "r", encoding="utf-8") as f:
    phobias = json.load(f)["phobias"]

# 躁狂
with open(os.path.join(DATA_DIR, "mania.json"), "r", encoding="utf-8") as f:
